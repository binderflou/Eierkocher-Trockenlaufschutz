...
| **R5.4** | Fehlermeldung Trockenlauf, Quittierung | UI / ControlLogic | `DisplayController`, `SystemController` | `showWarning()` `acknowledgeError()` | 3 | `showWarning()`, `acknowledgeError()` | M7, M8, I7, I8, I9 (bestanden) |
